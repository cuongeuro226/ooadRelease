...
namespace BLL
{
     public class PositionBLL
    {
        ...
        public List<string> GetFuntionByPositionID(string positionID)
        {
            try
            {
                return positionDAL.GetFuntionByPositionID(positionID);
            }
            catch (Exception ex) { throw ex; }
        }
        public void Save(string PositionID, string PositionName, string Salary, string ControlID, List<string> arr)
        {
            try
            {
                positionDAL.SavePosition(PositionID,PositionName,Salary,ControlID,arr);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public void Update(string PositionID, string PositionName, string Salary, string ControlID,List<string>arr)
        {
            try
            {
                
                positionDAL.UpdatePosition(PositionID,PositionName,Salary,ControlID,"0",arr);
