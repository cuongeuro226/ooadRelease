...
namespace BLL
{
    public class EmployeeBLL
    {
                        ...
                        string luong, string ngayVaoLam, MemoryStream anhThe,string pass, string trangthai, List<string> arr)
        {
            try
            {
                EmployeeDAL.Save(manv,ten,gioitinh,cmnd,sdt,ngaysinh,diachi,noisinh,tuoi,chucvu,luong,ngayVaoLam,anhThe,pass,trangthai,arr);
            }
            catch(Exception e)
            {
                throw e;
                       ...
                       string luong, string ngayVaoLam, MemoryStream anhThe, string pass, string trangthai, List<string> arr)
        {
            try
            {
                EmployeeDAL.UpdateEmployee(manv, ten, gioitinh, cmnd, sdt, ngaysinh, diachi, noisinh, tuoi, chucvu, luong, ngayVaoLam, anhThe, pass, trangthai,arr);
                //update control
            }
            catch (Exception e)
            {
        ...
        public List<string> GetFuntionByPositionID(string positionID)
        {
            try
            {
                return EmployeeDAL.GetFuntionByPositionID(positionID);
            }
