...
using QuanLyCuaHangLinhKienMayTinh.Warehouse;
...
namespace QuanLyCuaHangLinhKienMayTinh
{
    public partial class frmMainForm : Form
    {
        ...
        public void loadEmpolyeeUsingThisForm()
        {
            MainFormBLL bll = new MainFormBLL();
            try {
                DTO.Employee thisMe = bll.GetEmployee(MaNV);


                txtInfoEmployee.Text = "MaNV:  "+MaNV+" \r\n\r\nTên: "+thisMe.EmployeeName+"  \r\n\r\nChức vụ: "+thisMe.PositionName+"\r\n\r\n\r\n\r\n";
                stiInfoEmployee.Text = "Chức vụ: "+ thisMe.PositionName + "    ||   Tên: "+ thisMe.EmployeeName + "    || ";
                //image
                byte[] b = bll.GetImage(thisMe.EmployeeID);
                MemoryStream mem = new MemoryStream(b);
                Image ima = Image.FromStream(mem, true);
                picEmployeeImage.BackgroundImage = ima;
            }
            catch(Exception ex) { MessageBox.Show("lỗi load dữ liệu nhân viên, mã lỗi:"+ex.Message); }
        }
